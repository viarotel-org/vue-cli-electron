<template>
  <transition name="slide-up">
    <div
      v-if="modelValue"
      class="fixed inset-0 z-20 h-full overflow-hidden text-white bg-gray-700"
    >
      <div
      ...
      <div
        class="flex items-center h-full mx-[12vw] xl:mx-[16vw] 2xl:mx-[20vw]"
      >
        <div class="flex-none">
          <div
          ...
          <div class="flex items-center justify-between mt-10">
            ...
            <div class="flex-none w-10 h-10 button-base hover:bg-opacity-10">
              <!-- name="heart-solid" -->
              <ViaSvgIcon
                name="heart"
                class="mt-px text-xl"
          ...
          <div class="flex items-center justify-center mt-6 space-x-4">
            ...
            <div class="w-14 h-14 button-base !rounded-2xl hover:bg-opacity-10">
              <!-- name="pause" -->
              <ViaSvgIcon
                name="play"
